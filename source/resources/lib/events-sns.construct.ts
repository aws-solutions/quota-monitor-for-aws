...
import { aws_events as events, aws_events_targets as targets, aws_sns as sns, Stack } from "aws-cdk-lib";
 ...
 */
export class EventsToSNS<T extends QuotaMonitorEvent> extends Construct implements IRuleToTarget<sns.Topic> {
